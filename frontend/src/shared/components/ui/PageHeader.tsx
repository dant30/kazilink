  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
        ...
        {/* Action Buttons Slot */}
        {actions && <div className="relative z-10 w-full shrink-0 self-start sm:w-auto sm:self-end [&>div]:flex-nowrap [&>div]:w-full [&>div>button]:min-w-0 [&>div>button]:flex-1 sm:[&>div>button]:whitespace-nowrap [&>div>a]:min-w-0 [&>div>a]:flex-1 sm:[&>div>a]:whitespace-nowrap sm:[&>div>button]:flex-none sm:[&>div>a]:flex-none">{actions}</div>}
      </div>
