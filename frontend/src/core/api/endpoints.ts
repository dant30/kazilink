...
export const endpoints = {
  auth: {
    ...
    workerOccupations: () => get<{ occupations: Array<{ value: string; label: string }>; availability: Array<{ value: string; label: string }>; locations: Array<{ value: string; label: string }>; skills: Array<{ value: string; label: string }>; business_types: Array<{ value: string; label: string }> }>('/accounts/worker-occupations/'),
