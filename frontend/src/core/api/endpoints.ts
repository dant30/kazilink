...
import type { CreditCatalogResponse, CreditLedgerEntry, CreditRecharge, CreditTransferResponse, CreditWalletResponse, PaymentInitiateInput, PaymentInitiateResponse, Transaction } from '../../features/payments/types'
...
export const endpoints = {
  ...
  credits: {
    ...
    transfer: (data: { recipient_phone: string; amount: number; idempotency_key: string }) => post<CreditTransferResponse>('/credits/transfer/', data),
  },
  subscriptions: {
